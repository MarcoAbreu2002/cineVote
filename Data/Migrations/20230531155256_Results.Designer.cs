...
namespace cineVote.Migrations
{
    ...
    [Migration("20230531155256_Results")]
            ...
            modelBuilder.Entity("cineVote.Models.Domain.Result", b =>
                {
                    ...
                    b.HasOne("cineVote.Models.Domain.CategoryNominee", "FirstPlace")
                        .WithMany()
                    ...
                    b.HasOne("cineVote.Models.Domain.CategoryNominee", "SecondPlace")
                        .WithMany()
                        .HasForeignKey("SecondPlaceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("cineVote.Models.Domain.CategoryNominee", "ThirdPlace")
                        .WithMany()
